...
from videotheque.movie.models import Director
...
class MovieSerializer(serializers.Serializer):
    ...
    director = serializers.PrimaryKeyRelatedField('Director', many=True, queryset=Director.objects.all())
    identification_number = serializers.IntegerField(unique=True)
    ...
    def update(self, instance, validated_data):
        ...
        if director := validated_data.get('director'):
